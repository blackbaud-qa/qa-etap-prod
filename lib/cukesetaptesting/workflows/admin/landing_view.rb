module Cukesetaptesting
  module Admin
    class LandingView < BaseView
      ...
      keyword(:home_dd) {navbar_tab('homeTab').link(:index=>0)}
      ...
      keyword(:accounts_dd) {navbar_tab('accountTab').link(:index=>0)}
      ...
      keyword(:giving_dd) {navbar_tab('givingTab').link(:index=>0)}
      ...
      keyword(:communications_dd) {navbar_tab('communicationTab').link(:index=>0)}
      ...
      keyword(:queries_dd) {navbar_tab('queriesTab').link(:index=>0)}
      ...
      keyword(:reports_dd) {navbar_tab('reportsTab').link(:index=>0)}
  ...
  #    keyword(:management_dd) {navbar_tab('manageTab').img(:class, "menuTabButton")}
      ...
      keyword(:home_dd_find_account) {home_quick_links.a(:href, "/prod/entitySearch2.do")}
      ...
      #DEV_HELP
      keyword(:reports_dd_top_donor) {reports_div.ul(:id,'reportRecent').a(:text,'Top Donor Report')}
      keyword(:reports_dd_journal) {reports_div.ul(:id,'reportRecent').a(:href,'/prod/reportLauncher.do?nextAction=journalEntryListReport.do&mode=report&type=JournalEntryList&name=Journal%20Entry%20List')}
      keyword(:reports_dd_recency) {reports_div.ul(:id,'reportRecent').a(:href,'/prod/reportLauncher.do?nextAction=recencyReport.do&type=RecencyReport&mode=report&name=Recency%20Report')}
      ...
      keyword(:management_dd_ncoa) {management_div.ul(:id,'manageAdminItems1').a(:href,'/prod/ncoa.do')}
      keyword(:management_dd_social_media_finder) {management_div.ul(:id,'manageAdminItems1').a(:href,'/prod/socialFinder.do')}
