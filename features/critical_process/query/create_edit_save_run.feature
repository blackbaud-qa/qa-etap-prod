...
###  Cannot run until chrome ext error is fixed  ###
...
#    And I should see the message 'Sorry, we were unable to perform the action you requested.  This query has a dependant and can not be deleted' in an alert window
