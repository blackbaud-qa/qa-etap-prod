...
#### Substituting the following steps until "And I click the X on the Recently Viewed Accounts tile" works so that the two steps above pass. ###
#    And I click on Select Tiles and Layout
#    And I click Recently Viewed Accounts
#    And I click Save
#    Then I should not see the Recently Viewed Accounts tile in the right hand column on the Dashboard
...
#    And I set the Start Date to '1/1/2015' and I set the End Date to '1/31/2015'
#    And I click Update on the Campaign Performance tile
#    And I click 'See Full Report' on the Campaign Performance tile
#    And I should see 'Displaying 1 - 13 of 13' on the full Campaign Performance report
