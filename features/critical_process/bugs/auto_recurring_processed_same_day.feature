...
#    And I verfiy that the Supports EFT checkbox is marked
...
#    And I click Save And 'Go to Journal'
#    And I click OK to confirm my desire to process the first gift now
#    And I click on the 'Recurring Gift' in the journal
#    And the date field should be populated with Today
