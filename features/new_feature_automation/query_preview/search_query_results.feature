...
Feature: Ability to search for Account Name in the query results
  ...
  Scenario: Search for and account without any name field columns
    ...
    And I click on the magnifying glass in the search field
    Then I should see '4' results on the query preview page
    And I should see a journal entry dated '2/27/14' on the query preview page
    And I should see a journal entry dated '9/1/15' on the query preview page
    And I should see a journal entry dated '8/22/14' on the query preview page
    And I should see a journal entry dated '9/7/14' on the query preview page
